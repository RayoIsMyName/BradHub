...
local Window = Library.CreateLib("South London 2", "DarkTheme")
local Tab = Window:NewTab("AutoFarm")
Section:NewButton("KittenWare AutoFarm", "AutoFarm", function(https://raw.githubusercontent.com/GlockClipz/Kitten-Ware/main/Auto%20Farm)
    print("Clicked")
end)
local Tab = Window:NewTab("SL2 Killer")
Section:NewButton("SL2 Killer", "SL2K", function(https://raw.githubusercontent.com/tututu1mn13/SL2Killerr/main/script.lua)
    print("Clicked")
end)
local Tab = Window:NewTab("KittenWare")
Section:NewButton("KittenWare", "BestSL2 Script", function(https://raw.githubusercontent.com/GlockClipz/Kitten-Ware/main/SL2%20Ware)
    print("Clicked")
end)
local Tab = Window:NewTab("ESP")
Section:NewButton("ESP", "Best Universal ESP", function(local custom_theme = {} --soon
